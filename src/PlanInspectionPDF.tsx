...
import { PlanInspectionFormPDF } from "./PlanInspectionFormPDF";
...
export const PlanInspectionPDF = ({
  ...
  function getTodayDate(): string {
    ...
    const month = String(today.getMonth() + 1).padStart(2, "0"); // Les mois commencent à 0 en JavaScript
    const year = today.getFullYear();

    return `${day}/${month}/${year}`;
  }
  const DateDuJour = getTodayDate();
  ...
  return (
    <Document>
      <Page renderTextLayer={false} style={tw("p-2 text-sans")} size="A4">
        ...
        <TableauPDF className="my-4" themeColor={themeColor}>
          <LignePDF className="">
        ...
        <TableauPDF className="my-4" themeColor={themeColor}>
          ...
          <LignePDF className="">
            ...
            <Cellule className="">{DateDuJour} </Cellule>
        ...
        <TableauPDF className="my-4" themeColor={themeColor}>
          <LignePDF className="">
            ...
            <Cellule className={"w-full  "}>{data.verificationDate}</Cellule>
          </LignePDF>
          <LignePDF>
            <Cellule variant="blue" className="">
              Nom du site
        ...
        <TableauPDF className="my-4" themeColor={themeColor}>
          ...
          <LignePDF className="">
            ...
            <Cellule className={"w-full  "}>{DateDuJour}</Cellule>
          </LignePDF>
          <LignePDF className="">
            <Cellule variant="blue" className="w-3/12 ">
              Par :
        ...
        <TableauPDF className="my-4 border-l" themeColor={themeColor}>
          <LignePDF>
            <Cellule variant="blue" className="">
      ...
      <Page renderTextLayer={false} style={tw(" p-16 text-sans")} size="A4">
        <TableauPDF themeColor={themeColor} className="mb-4">
          <LignePDF>
        ...
        <PlanInspectionFormPDF data={data} themeColor={themeColor} />
      </Page>
      <Page renderTextLayer={false} style={tw(" p-16 text-sans")} size="A4">
...
export const Cellule = ({
  ...
  variant?: "blue" | "white";
  children: ReactNode | string | Date;
  className?: string;
}) => {
  return (
    <>
