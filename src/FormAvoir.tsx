...
export const avoirSchema = z.object({
  objetAvoir: z.string().min(1, "Objet avoir est requis"),
...
export type AvoirSchema = z.infer<typeof avoirSchema>;
    ...
    <>
      <div className="flex flex-col items-center">
        <form className="w-4/5 p-3 text-xl">
          <div className="my-3">
            <label htmlFor="objetAvoir">Objet Avoir</label>
            <Input id="objetAvoir" {...register("objetAvoir")} />
            {errors.objetAvoir && (
              <p className="text-sm text-red-500">
                {errors.objetAvoir.message}
              </p>
            )}
          </div>
